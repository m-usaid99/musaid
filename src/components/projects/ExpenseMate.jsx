...
function ExpenseMate() {
  const [isFrontendCollapsed, setIsFrontendCollapsed] = useState(true);
          ...
          <div className={styles.devProcessSection}>
            ...
            <div className={styles.devProcessContent}>
              <div className={styles.frontend}>
                <h2
                  className={styles.devProcessSubHeading}
                  onClick={() => isMobile && setIsFrontendCollapsed(!isFrontendCollapsed)}
                  style={{ cursor: isMobile ? 'pointer' : 'default' }}
                >
                  FrontEnd & API Integration {isMobile && (isFrontendCollapsed ? '+' : '-')}
                </h2>
                {!isMobile || !isFrontendCollapsed ? (
                  <>
              ...
              <div className={styles.backend}>
                <h2
                  className={styles.devProcessSubHeading}
                  onClick={() => isMobile && setIsBackendCollapsed(!isBackendCollapsed)}
                  style={{ cursor: isMobile ? 'pointer' : 'default' }}
                >
                  Backend Development {isMobile && (isBackendCollapsed ? '+' : '-')}
                </h2>
                {!isMobile || !isBackendCollapsed ? (
                  <>
                    <div className={styles.devProcessItem}>
                      <h3>Initial Setup and Architecture</h3>
                      <p>
